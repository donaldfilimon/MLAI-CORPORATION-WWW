...
import { investorsContent } from "@/lib/content";
...
export default function InvestorsPage() {
  return (
    <>
      ...
      <Section eyebrow="The case" title="A timing bet, not a technology gamble" accent="wdbx">
        <Prose>
          {investorsContent.narrative.map((para, i) => (<p key={i}>{para}</p>))}
        </Prose>
      </Section>

      <Section eyebrow="Why now, in depth" title="Four forces moving the same direction" accent="wdbx">
        <DeepDive items={investorsContent.whyNowExpanded} accent="wdbx" cols={2} />
      </Section>

      <Section eyebrow="Questions" title="What investors ask" accent="wdbx">
        <FAQList items={investorsContent.faq} accent="wdbx" />
      </Section>
