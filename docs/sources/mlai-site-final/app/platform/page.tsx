...
export default function PlatformPage() {
  return (
    <>
      ...
      <Section eyebrow="Why it exists" title="Autonomy you can answer for" accent="abi">
        <Prose>
          {platformContent.intro.map((para, i) => (
            <p key={i}>{para}</p>
          ))}
        </Prose>
      </Section>

      <Section eyebrow="The four layers, in depth" title="What each layer actually does" accent="abi">
        <DeepDive items={platformContent.layersDetail} accent="abi" cols={2} />
      </Section>

      <Section eyebrow="Principles" title="How the platform thinks" accent="abi">
        <DeepDive items={platformContent.principles} accent="abi" cols={3} />
      </Section>
      ...
      <Section eyebrow="Questions" title="What people ask about the platform" accent="abi">
        <FAQList items={platformContent.faq} accent="abi" />
      </Section>
