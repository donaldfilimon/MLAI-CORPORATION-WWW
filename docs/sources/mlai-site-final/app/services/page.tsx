...
import { Prose, DeepDive } from "@/components/content";
...
export default function ServicesPage() {
  return (
    <>
      ...
      <Section eyebrow="How we work" title="A few deep builds, not generic hours" accent="abbey">
        <Prose>
          {servicesContent.intro.map((para, i) => (<p key={i}>{para}</p>))}
        </Prose>
        <div className="mt-8">
          <DeepDive items={servicesContent.engagementModel} accent="abbey" cols={3} />
        </div>
      </Section>
