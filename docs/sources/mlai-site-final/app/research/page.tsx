...
export default function ResearchPage() {
  return (
    <>
      ...
      <Section eyebrow="Why we publish" title="Claims you can check" accent="abi">
        <Prose>
          {researchContent.intro.map((para, i) => (<p key={i}>{para}</p>))}
        </Prose>
        <div className="mt-8">
          <DeepDive items={researchContent.themes} accent="abi" cols={3} />
        </div>
      </Section>
