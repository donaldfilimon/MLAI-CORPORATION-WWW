...
/* Minimal line icons drawn with react-native-svg — no icon-font dependency.
   NEW: "chat". REMOVED: "platform" — its four layers moved into the Stack tab,
   because six tabs is one too many for iOS and Platform never stood alone. */
...
export default function TabLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="stack" options={{ title: "Stack", tabBarIcon: ({ focused }) => <Icon name="stack" focused={focused} /> }} />
      <Tabs.Screen name="chat" options={{ title: "Chat", tabBarIcon: ({ focused }) => <Icon name="chat" focused={focused} /> }} />
