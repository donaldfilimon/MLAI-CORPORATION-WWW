  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-ink/85 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <Link href="/" className="flex items-center gap-3" aria-label="MLAI home">
          <span className="grid h-7 w-7 place-items-center border border-line bg-panel font-mono text-[10px] font-bold text-wdbx">
            ML
          </span>
