...
## Integration repository validation — 2026-09-08

This application now also lives at `apps/website-app` in MLAI-CORPORATION-WWW.
The imported checkout passed its frozen install, setup (23 document formats),
TypeScript/shared UI, 107 unit tests, 26 parser tests, production build,
formatting and research validation. Public research browser checks passed in
Chromium, Firefox and WebKit at 320/390/768/1440 px on isolated port 3111.
The full authenticated browser suite and live model/ABI/WDBX acceptance were
not repeated. Prior receipts remain historical. See the integration repository's
[`docs/website-app-integration.md`](../../../docs/website-app-integration.md)
for provenance, runtime versions, command wiring and exact gate boundaries.
