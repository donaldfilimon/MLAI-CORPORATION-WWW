...
export function Login() {
  ...
  const errorCopy =
    error === "organization_access_required"
      ? "Your account isn't in the Quesar beta yet. Request access, or ask your organization administrator for an invitation."
      : error === "auth_failed"
      ...
      <m.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="relative z-10 grid w-full max-w-5xl gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <section className="glass-card flex flex-col justify-between" aria-labelledby="login-heading">
          <div className="pb-2 text-center">
            ...
            <p className="text-sm text-text-dim">{requesting ? "Tell Quesar which governed workflow you want to evaluate." : "Continue with the account named in your organization invitation."}</p>
          </div>
