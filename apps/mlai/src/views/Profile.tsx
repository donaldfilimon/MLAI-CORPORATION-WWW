  ...
  return (
    <div className="container-custom min-h-screen pt-32 pb-20 font-sans">
      <div className="mb-10 max-w-3xl">
        ...
        <p className="section-subtitle">Customize your Quesar account, verify the real WorkOS user behind the session, and prepare billing activation.</p>
      </div>
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2">
        {billing?.plans.map((plan) => (
          <div key={plan.id} className="glass-card flex flex-col justify-between">
            <div>
              <CreditCard className="mb-4 h-8 w-8 text-sky-400" />
