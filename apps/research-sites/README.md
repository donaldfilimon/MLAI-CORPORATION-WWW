...
The public/ directory contains the exact approved structured research collection and shared renderers. No runtime secrets, production APIs or independent prose. Rebuild with the canonical exporter, apps/web/scripts/export-research.tsx in this repository; see public/research-manifest.json for provenance.
