    ...
    <div className="home-page flex flex-col items-center overflow-hidden">
      ...
      <Reveal width="100%">
        <Section
          ...
          lead="Identity, provider, and audit are the same request—not settings an operator has to remember to align."
        >
          ...
          <div className="container-custom">
            <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-linear-to-br from-cyan-600/20 via-bg to-violet-500/10 p-8 md:p-14">
              ...
              <div className="relative z-10 grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
                ...
                <div className="flex flex-col gap-3 sm:flex-row lg:flex-col"><Button asChild size="lg" className="rounded-full bg-white px-7 text-black hover:bg-cyan-50"><Link to="/login">Enter Quesar <ArrowRight className="h-4 w-4" /></Link></Button><Button onClick={openInquiry} size="lg" variant="outline" className="rounded-full">Start an inquiry</Button></div>
              </div>
            </div>
          </div>
        </Reveal>
