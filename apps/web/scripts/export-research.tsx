...
await writeFile(path.join(stage,'package.json'), JSON.stringify({name:'mlai-research-review-artifact',private:true,description:'Generated static artifact. Edit research source in the canonical MLAI repository; do not edit this snapshot.'},null,2)+'\n');
