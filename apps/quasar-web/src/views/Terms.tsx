        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-text-dim">
              Users of Quesar, Quesar services, demos, protected APIs, and
          ...
          <section>
            ...
            <p className="text-text-dim">
              Quesar names, content, code, designs, research materials, and
          ...
          <section>
            ...
            <p className="text-text-dim">
              Quesar provides website, research, and preview API materials as-is
