...
const SURFACES: Surface[] = [
  {
    ...
    blurb:
      "The Quesar story — persona routing, verifiable memory, and governance — hosted by Abbey, Aviva, and Abi with on-device neural narration.",
    icon: FilmIcon,
        ...
        <div className="container-custom">
          ...
          <div className="mb-10 grid gap-8 lg:mb-20 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.44fr)] lg:items-end">
            ...
            >
              ...
              your browser, narrated by the three Quesar minds with a neural
