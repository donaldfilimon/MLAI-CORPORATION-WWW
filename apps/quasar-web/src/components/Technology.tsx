...
// Quesar ships no silicon, so nothing
        ...
        <div className="flex flex-col lg:flex-row-reverse gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-text-dim mb-10 leading-relaxed">
              At the heart of Quesar's infrastructure sits WDBX — the Weighted Directed Backtrace eXecution store. Its active Rust substrate combines HNSW retrieval, MVCC, and inspectable history. Confidence signals along those paths are designed to reduce hallucination surfaces, not to remove them.
            </p>
