...
import { Shield, Zap, Target, Globe, Building2, Activity, Users } from 'lucide-react';
...
export const About = () => {
  ...
  return (
    <section id="about" className="py-24 bg-surface/50 relative overflow-hidden noise-overlay" aria-labelledby="about-heading">
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <ul className="space-y-4 font-mono text-sm text-blue-400/80 mb-8" role="list">
            ...
            <Link to="/research">
              <Button variant="outline" className="inline-flex items-center gap-2 text-sm">
                Read Our Research →
              </Button>
            </Link>
          </div>
              ...
              {content.about.values.map((item, i) => (
                ...
                >
                  <Card variant="glass" className="h-full p-6">
                    <div className="w-10 h-10 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-4" aria-hidden="true">
                      {icons[i]}
                    </div>
      ...
      <div className="container-custom mt-32 relative z-10">
        <div className="bg-gradient-to-br from-blue-600/20 to-cyan-500/10 border border-white/10 rounded-[2.5rem] p-12 md:p-20 relative overflow-hidden group">
          ...
          <div className="max-w-3xl relative z-10">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-8">Our Mission: <br/>Ensuring the Safety of <span className="text-blue-400">Autonomous Progress.</span></h2>
            <p className="text-xl text-text-dim leading-relaxed mb-10">
              As AI systems transition from generative tools to autonomous agents, the margin for error disappears. Our mission is to provide the structural integrity required for this transition, building the guardrails, backtrace engines, and orchestration layers that make autonomous intelligence a force for positive, predictable change.
            </p>
            <div className="flex flex-wrap gap-12">
              <div>
                <div className="text-3xl font-display font-bold text-white mb-1">2024</div>
                <div className="text-xs font-mono uppercase tracking-widest text-blue-400">Founded</div>
              </div>
              <div>
                <div className="text-3xl font-display font-bold text-white mb-1">100%</div>
                <div className="text-xs font-mono uppercase tracking-widest text-blue-400">Private-First Patterns</div>
              </div>
              <div>
                <div className="text-3xl font-display font-bold text-white mb-1">Global</div>
                <div className="text-xs font-mono uppercase tracking-widest text-blue-400">Research Network</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container-custom mt-20 relative z-10">
        <CardGrid cols={2} className="gap-6">
          {content.about.operatingPrinciples.map((principle) => (
            <Card key={principle} variant="glass" className="text-sm leading-relaxed text-text-dim p-6">
              {principle}
            </Card>
          ))}
        </CardGrid>
