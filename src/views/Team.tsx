...
import { team } from '@/data/categories/team';
      ...
      <div className="container-custom relative z-10">
        ...
        <CardGrid cols={3} className="gap-8">
              ...
              <div className="glass-card group h-full p-5">
                <div>
                  ...
                  {member.slug && (
                    <Link
                      to={`/team/${member.slug}`}
                      className="mt-4 inline-flex items-center gap-2 text-xs font-mono uppercase tracking-[0.15em] text-white hover:text-cyan-400 transition-colors"
                    >
                      Read profile
          ...
          >
            <Card
              variant="glass"
              className="h-full border border-dashed border-cyan-500/20 bg-cyan-500/5 flex flex-col items-center justify-center p-12 text-center group hover:bg-cyan-500/10 hover:border-cyan-500/30 transition-all duration-500"
            >
              ...
              <Button
                ...
                className="text-xs font-mono uppercase tracking-[0.2em] text-cyan-400 hover:text-white transition-colors flex items-center gap-2"
              >
