  ...
  "relative w-full rounded-xl border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        success:
          "border-indigo-500/50 text-indigo-500 dark:border-indigo-500 [&>svg]:text-indigo-500 bg-indigo-500/5",
        warning:
          "border-yellow-500/50 text-yellow-500 dark:border-yellow-500 [&>svg]:text-yellow-500 bg-yellow-500/5",
      },
    },
    defaultVariants: {
      variant: "default",
