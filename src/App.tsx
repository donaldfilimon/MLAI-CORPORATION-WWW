    ...
    <ErrorBoundary>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Leading AI and ML research lab providing high-integrity frameworks for neural AI orchestration.",
          "address": {
            "@type": "PostalAddress",
      ...
      <Router>
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="research" element={<div className="pt-10"><Research /></div>} />
            <Route path="services" element={<div className="pt-10"><Services /></div>} />
            <Route path="team" element={<div className="pt-10"><Team /></div>} />
