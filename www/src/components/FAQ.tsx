        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              <div
                className="flex items-center gap-2 text-cyan-400 font-mono text-sm mb-4"
                aria-hidden="true"
              >
          ...
          <div className="lg:col-span-8">
            <Accordion defaultValue={["item-0"]} className="w-full">
              {faq.map((item, i) => (
                ...
                >
                  <AccordionTrigger className="text-lg font-semibold text-white hover:text-cyan-400 hover:no-underline transition-colors py-6 pr-8 text-left">
                    {item.question}
                  </AccordionTrigger>
